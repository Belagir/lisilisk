/**
 * @file 3dful_application.c
 * @author Gabriel Bédat
 * @brief Implementation of window and opengl context creation procedures.
 * @version 0.1
 * @date 2025-07-26
 *
...
/**
 * @brief Initialize a SDL window and an OpenGL context.
 *
 * @param[in] name
 * @param[in] width
 * @param[in] height
...
/**
 * @brief Destroys a window / OpenGL context.
 *
 * @param[inout] target
 */
